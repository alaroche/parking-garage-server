class ApplicationController < ActionController::API
  def show
    ...
    json['parking_levels'].each_with_index do |level,i|
      ...
      obj['parking_levels'][i]['spots_taken'] = r.keys.any? ? (spots_on_level & r.keys.map { |k| Integer(k) }).size : 0
      ...
      obj['total_spots_free'] += obj['parking_levels'][i]['total_spots'] - obj['parking_levels'][i]['spots_taken']
    end
